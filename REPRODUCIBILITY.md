...
| Main Table 3. Example of the training corpus | `data/inter_annotator_agreement.xlsx`, `'2022人工标注对照表'!A2:N4` | Illustrative excerpt; no statistical transformation | Manuscript table |
...
| Table S2. Annotation-pipeline validation | `data/inter_annotator_agreement.xlsx`, `'2022人工标注对照表'!K2:N40`; `semantic_annotation/training_data/test_set_84.xlsx`, `Sheet1!E2:H85` | `analysis/evaluate_annotation.py`; `analysis/export_report_tables.py` | `analysis/report_tables/table_s2_validation_summary.csv` |
